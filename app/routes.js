...
router.use('/another-decision-0-0-8', require('./routes/another-decision-0-0-8/router.js'));
...
router.use('/citizen-record-0-0-2', require('./routes/citizen-record-0-0-2/router.js'));
