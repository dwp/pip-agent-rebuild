...
router.post(`/dwa-prep-linear-outcome-router`, (req, res) => {
  const preparationOutcomeTaskList = req.session.data['dwa-prep-linear-outcome']
...
router.post(`/dwa-prep-tasklist-item-1-router`, (req, res) => {
  const preparationCheckItem1 = req.session.data['dwa-prep-tasklist-item-1']

  if (preparationCheckItem1 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-2`)
  }
  else if (preparationCheckItem1 == 'Unexpected') {
    res.redirect(`dwa-prep-tasklist-item-2`)
  }
  else if (preparationCheckItem1  == 'Pause') {
    res.redirect(`mr-dwa-prep-tasklist`)
  }
   else {
     res.redirect(`XXX`)
  }
...
router.post(`/dwa-prep-tasklist-item-2-router`, (req, res) => {
  const preparationCheckItem2 = req.session.data['dwa-prep-tasklist-item-2']

  if (preparationCheckItem2 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-3`)
  }
...
router.post(`/dwa-prep-tasklist-item-3-router`, (req, res) => {
  const preparationCheckItem3 = req.session.data['dwa-prep-tasklist-item-3']

  if (preparationCheckItem3 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-3a`)
  }
...
router.post(`/dwa-prep-tasklist-item-3a-router`, (req, res) => {
  const preparationCheckItem3a = req.session.data['dwa-prep-tasklist-item-3a']

  if (preparationCheckItem3a == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-4`)
  }
...
router.post(`/dwa-prep-tasklist-item-4-router`, (req, res) => {
  const preparationCheckItem4 = req.session.data['dwa-prep-tasklist-item-4']

  if (preparationCheckItem4 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-5`)
  }
...
router.post(`/dwa-prep-tasklist-item-5-router`, (req, res) => {
  const preparationCheckItem5 = req.session.data['dwa-prep-tasklist-item-5']

  if (preparationCheckItem5 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-5-1`)
  }
...
router.post(`/dwa-prep-tasklist-item-5-1-router`, (req, res) => {
  const preparationCheckItem51 = req.session.data['dwa-prep-tasklist-item-5-1']

  if (preparationCheckItem51 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-5-2`)
  }
...
router.post(`/dwa-prep-tasklist-item-5-2-router`, (req, res) => {
  const preparationCheckItem52 = req.session.data['dwa-prep-tasklist-item-5-2']

  if (preparationCheckItem52 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-6`)
  }
...
router.post(`/dwa-prep-tasklist-item-6-router`, (req, res) => {
  const preparationCheckItem6 = req.session.data['dwa-prep-tasklist-item-6']

  if (preparationCheckItem6 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-7`)
  }
...
router.post(`/dwa-prep-tasklist-item-7-router`, (req, res) => {
  const preparationCheckItem7 = req.session.data['dwa-prep-tasklist-item-7']

  if (preparationCheckItem7 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-8`)
  }
...
router.post(`/dwa-prep-tasklist-item-8-router`, (req, res) => {
  const preparationCheckItem8 = req.session.data['dwa-prep-tasklist-item-8']

  if (preparationCheckItem8 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-9`)
  }
...
router.post(`/dwa-prep-tasklist-item-9-router`, (req, res) => {
  const preparationCheckItem9 = req.session.data['dwa-prep-tasklist-item-9']

  if (preparationCheckItem9 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-10`)
  }
  else if (preparationCheckItem9 == 'Unexpected-spa') {
    res.redirect(`dwa-prep-tasklist-item-9-1`)
  }
...
router.post(`/dwa-prep-tasklist-item-9-1-router`, (req, res) => {
  const preparationCheckItem9_1 = req.session.data['dwa-prep-tasklist-item-9-1']
...
router.post(`/dwa-prep-tasklist-item-10-router`, (req, res) => {
  const preparationCheckItem10 = req.session.data['dwa-prep-tasklist-item-10']

  if (preparationCheckItem10 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-11`)
  }
...
router.post(`/dwa-prep-tasklist-item-11-router`, (req, res) => {
  const preparationCheckItem11 = req.session.data['dwa-prep-tasklist-item-11']

  if (preparationCheckItem11 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-12`)
  }
...
router.post(`/dwa-prep-tasklist-item-12-router`, (req, res) => {
  const preparationCheckItem12 = req.session.data['dwa-prep-tasklist-item-12']

  if (preparationCheckItem12 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-13`)
  }
...
router.post(`/dwa-prep-tasklist-item-13-router`, (req, res) => {
  const preparationCheckItem13 = req.session.data['dwa-prep-tasklist-item-13']

  if (preparationCheckItem13 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-14`)
  }
...
router.post(`/dwa-prep-tasklist-item-14-router`, (req, res) => {
  const preparationCheckItem14 = req.session.data['dwa-prep-tasklist-item-14']

  if (preparationCheckItem14 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-15`)
  }
...
router.post(`/dwa-prep-tasklist-item-15-router`, (req, res) => {
  const preparationCheckItem15 = req.session.data['dwa-prep-tasklist-item-15']

  if (preparationCheckItem15 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-16`)
  }
...
router.post(`/dwa-prep-tasklist-item-16-router`, (req, res) => {
  const preparationCheckItem16 = req.session.data['dwa-prep-tasklist-item-16']

  if (preparationCheckItem16 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-17`)
  }
...
router.post(`/dwa-prep-tasklist-item-17-router`, (req, res) => {
  const preparationCheckItem17 = req.session.data['dwa-prep-tasklist-item-17']

  if (preparationCheckItem17 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-18`)
  }
...
router.post(`/dwa-prep-tasklist-item-18-router`, (req, res) => {
  const preparationCheckItem18 = req.session.data['dwa-prep-tasklist-item-18']

  if (preparationCheckItem18 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-19`)
  }
...
router.post(`/dwa-prep-tasklist-item-19-router`, (req, res) => {
  const preparationCheckItem19 = req.session.data['dwa-prep-tasklist-item-19']

  if (preparationCheckItem19 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-20`)
  }
...
router.post(`/dwa-prep-tasklist-item-20-router`, (req, res) => {
  const preparationCheckItem20 = req.session.data['dwa-prep-tasklist-item-20']

  if (preparationCheckItem20 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-21`)
  }
...
router.post(`/dwa-prep-tasklist-item-21-router`, (req, res) => {
  const preparationCheckItem21 = req.session.data['dwa-prep-tasklist-item-21']

  if (preparationCheckItem21 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-22`)
  }
...
router.post(`/dwa-prep-tasklist-item-22-router`, (req, res) => {
  const preparationCheckItem22 = req.session.data['dwa-prep-tasklist-item-22']

  if (preparationCheckItem22 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-23`)
  }
...
router.post(`/dwa-prep-tasklist-item-23-router`, (req, res) => {
  const preparationCheckItem23 = req.session.data['dwa-prep-tasklist-item-23']

  if (preparationCheckItem23 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-24`)
  }
...
router.post(`/dwa-prep-tasklist-item-24-router`, (req, res) => {
  const preparationCheckItem24 = req.session.data['dwa-prep-tasklist-item-24']

  if (preparationCheckItem24 == 'Expected') {
    res.redirect(`dwa-prep-tasklist-item-25`)
  }
...
router.post(`/dwa-prep-tasklist-item-25-router`, (req, res) => {
  const preparationCheckItem25 = req.session.data['dwa-prep-tasklist-item-25']
...
router.post(`/dwa-prep-mm-tasklist-outcome-router`, (req, res) => {
  const preparationOutcomeTaskList = req.session.data['dwa-prep-mm-tasklist-outcome']
...
router.post(`/dwa-prep-task-outcome-router`, (req, res) => {
  const preparationOutcomeTaskList = req.session.data['dwa-prep-task-outcome']
