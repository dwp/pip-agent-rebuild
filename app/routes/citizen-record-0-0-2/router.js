...
// PDF DOWNLOADER
router.use(`/pip-letter.pdf`, express.static(path.resolve('app/views/pdfs/pip-letter.pdf')))
router.use(`/pip-doc1.pdf`, express.static(path.resolve('app/views/pdfs/pip-doc1.pdf')))
router.use(`/pip-doc2.pdf`, express.static(path.resolve('app/views/pdfs/pip-doc2.pdf')))
router.use(`/pip-doc3.pdf`, express.static(path.resolve('app/views/pdfs/pip-doc3.pdf')))
router.use(`/pip-doc4.pdf`, express.static(path.resolve('app/views/pdfs/pip-doc4.pdf')))
router.use(`/pip-doc5.pdf`, express.static(path.resolve('app/views/pdfs/pip-doc5.pdf')))
router.use(`/pip-doc8.pdf`, express.static(path.resolve('app/views/pdfs/pip-doc8.pdf')))
router.use(`/pip-doc9.pdf`, express.static(path.resolve('app/views/pdfs/pip-doc9.pdf')))
router.use(`/nil-award-letter.pdf`, express.static(path.resolve('app/views/pdfs/nil-award-letter.pdf')))
...
router.post(`/system-citizen-record-selector-router`, (req, res) => {
  ...
  else if (systemCitizenRecordSelector == 'x1') {
    res.redirect(`home-citizen-x1`)
  }
  else {
